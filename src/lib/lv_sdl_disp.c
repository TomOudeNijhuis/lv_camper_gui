...
void lv_port_disp_init(int width, int height)
{
    ...
    texture = SDL_CreateTexture(
        renderer, (LV_COLOR_DEPTH == 32) ? (SDL_PIXELFORMAT_ARGB8888) : (SDL_PIXELFORMAT_RGB565),
    ...
    lv_display_set_buffers(display, fb1, fb2, buf_size, LV_DISPLAY_RENDER_MODE_PARTIAL);
...
static void printWMInfo(SDL_Window* window)
{
    ...
    {
        case SDL_SYSWM_UNKNOWN: printf("  Subsystem: Unknown\n"); break;
        case SDL_SYSWM_X11:
        ...
        case SDL_SYSWM_WAYLAND:
            ...
            break;
        case SDL_SYSWM_DIRECTFB: printf("  Subsystem: DirectFB\n"); break;
        case SDL_SYSWM_COCOA: printf("  Subsystem: macOS (Cocoa)\n"); break;
        case SDL_SYSWM_UIKIT: printf("  Subsystem: iOS (UIKit)\n"); break;
        case SDL_SYSWM_ANDROID: printf("  Subsystem: Android\n"); break;
        case SDL_SYSWM_VIVANTE: printf("  Subsystem: Vivante\n"); break;
        case SDL_SYSWM_OS2: printf("  Subsystem: OS/2\n"); break;
        case SDL_SYSWM_KMSDRM:
            ...
            break;
        default: printf("  Subsystem: Other\n"); break;
    }
}
...
void lv_sdl_handle_events(void)
{
    ...
    while(SDL_PollEvent(&event))
    {
        switch(event.type)
        {
            ...
            case SDL_FINGERUP: touch_data.touched = false; break;
