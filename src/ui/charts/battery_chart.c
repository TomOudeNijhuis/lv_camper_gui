...
bool update_energy_chart_with_history(entity_history_t* history_data)
{
       ...
       history_data->valid)
    {
        ...
        energy_max_line =
            chart_create_line(energy_chart, "energy max line", lv_palette_main(LV_PALETTE_ORANGE),
        ...
        energy_max_label = chart_create_value_label(energy_chart, "energy max label",
                                                    lv_palette_main(LV_PALETTE_ORANGE),
                                                    max_ah_change, "Ah", LV_ALIGN_TOP_LEFT, 5, -8);
        if(energy_max_label == NULL)
        {
            return false;
        }
